...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" --git-dir=.git show-ref "asio-1-34-2"
  WORKING_DIRECTORY "D:/pub_sub/build/_deps/asio_src-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/pub_sub/build/_deps/asio_src-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/pub_sub/build/_deps/asio_src-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
